...
import { DownloadAggsType } from '~/src/api/loader/loadDownloadAggs';
import Button from '~/src/components/Button';
import DownloadListItem from '~/src/components/DownloadListItem';
import Notifications from '~/src/components/Notifications';
import Pagination from '~/src/components/Pagination';
import ScrollToTopOnNavigate from '~/src/components/ScrollToTop';
import { ViewStyles } from '~/src/configuration/constants/ViewStyle';
import { DownloadResponseType, ViewLayoutType } from '~/types';
import { OutletContextType } from './_home';
...
const Download = () => {
  ...
  const { userConfig, setCurrentPage } = useOutletContext<OutletContextType>();
